...
function HorizontalNavbar() {
    ...
    function LoginBtnHandler(e) {
        ...
        AuthService.login(userItem).then(setUser(localStorage.getItem("user")));
    }
                ...
                <div className={classes.btnContainer}>
                    ...
                    <Modal show={showLogin} onHide={handleCloseLogin}>
                        ...
                        <Modal.Footer>
                            ...
                            <Button variant="primary" className="btn-danger" onClick={LoginBtnHandler}>
                                Login
                            </Button>
                        </Modal.Footer>
                    </Modal>
                    <Modal show={showRegister} onHide={handleCloseRegister}>
                        ...
                        <Modal.Footer>
                            ...
                            <Button variant="primary" className="btn-danger" onClick={handleRegisterBtn}>
                                Create Account
                            </Button>
                        </Modal.Footer>
                    </Modal>
