import classes from "./style/NewNavbar.module.css"
        ...
        <div className={classes.content}>
            <div className={classes.wrapper}>
                <div className={classes.searchBar}>
                    <input className={classes.searchQueryInput} type="text" name="searchQueryInput" placeholder="Search" onChange={e => {setSearchText(e.target.value)}}/>
                    <button className={classes.searchQuerySubmit} type="submit" name="searchQuerySubmit" onClick={handleSearchButton}>
