...
import OrderList from "../components/events/OrderList";
...
const MY_TICKETS = [{orderId: 12, eventName: "Untold", eventId: 1, orderDate: "someDate", eventDate: "someDate"}, {orderId: 13, eventName: "Neversea", eventId: 2, orderDate: "someDate", eventDate: "someDate"}]
...
function ClientUserProfilePage() {
    ...
    console.log("orders ", MY_TICKETS[0]);
    ...
    return (
        <div className={classes.profileContainer}>
            ...
            <div className={classes.ticketsContainer}>
                <h1 className={classes.username}>My Tickets</h1>
